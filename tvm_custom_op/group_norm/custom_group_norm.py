...
@CUSTOM_OP.register("CustomGroupnorm")
class CustomGroupnormOp(CustomCpuExternOp):

    # 提供算子的外部C函数名
    func_name = "CustomGroupnorm_arm"

    # 提供源代码或者链接库路径，如果为C代码文件则自动编译
    files = ["custom_group_norm.cc"]
    ...
    def infer_type(self, inputs, attrs):
        ...
        return [{"shape": out_shape, "dtype": "float32"}]
